...
const MovieList = ({type, title, emoji}) => {
  ...
  `https://cors-anywhere.herokuapp.com/https://api.themoviedb.org/3/movie/${type}?api_key=58b1f21257879921bda9fde7dd53da38`
      ...
      console.log("Fetched Movies:", data); // <- Check this
    ...
    <section className='movie_list' id={type}>
      <header className='align_center movie_list_header'>
        ...
        <div className='align_center movie_list_fs'>
          ...
          <select name='by' id='' onChange={handleSort} value={sort.
          by} className='movie_sorting'>
            <option value="default">SortBy</option>
            <option value="release_date">Date</option>
            <option value="vote_average">Rating</option>
          </select>
          <select name="order" id='' onChange={handleSort} value=
          {sort.order} className='movie_sorting'>
